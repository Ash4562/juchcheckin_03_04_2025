...
const VerificationCards = () => {
  ...
  const cards = [
    { id: 1, title: "Aadhaar", image: "/aadhaar.png", path: "/AadharVerify" },
    { id: 2, title: "Driving License", image: "/license.png", path: "/driving" },
    { id: 3, title: "Passport", image: "/passport.png", path: "/Passportverify" },
    { id: 4, title: "Voter ID", image: "/badge.png", path: "/VotingIdVerifying" },
  ];
  ...
  {cards.map((card) => (
    ...
    >
      ...
      <img className="w-20 h-20 object-contain rounded-full aspect-square" src={card.image} alt={card.title} />
